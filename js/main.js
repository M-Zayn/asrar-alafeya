...
$(function() {
  ...
  $(".nav-bar .icons .search-icon").on("click", function() {
    $(".nav-bar .icons .search-icon button").toggleClass("lnr-magnifier");
    $(".nav-bar .icons .search-icon button").toggleClass("lnr-cross");
  ...
  // });
    ...
    // e.stopPropagation();
    $(".hoverd-menu").slideUp();
    $(".nav-list .list li.menu-hover, .hoverd-menu").on("click", function () {
      $(".hoverd-menu").slideToggle();
    });
